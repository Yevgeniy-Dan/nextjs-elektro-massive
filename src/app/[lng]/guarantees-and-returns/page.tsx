...
export async function generateMetadata({
  ...
  const description =
    params.lng === "uk"
      ? "Інформація про гарантійне обслуговування, умови повернення та обміну товарів. 14 днів на повернення, перевірка при отриманні, документи для повернення."
      : "Информация о гарантийном обслуживании, условия возврата и обмена товаров. 14 дней на возврат, проверка при получении, документы для возврата.";

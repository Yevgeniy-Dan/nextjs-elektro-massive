...
const Header = () => {
  ...
  return (
    <div className="bg-gradient-elektro-massive  rounded-r-3xl pl-4 sm:pl-8 md:pl-12 lg:pl-16 pr-2 -ml-6 md:-ml-16">
      <header className="mt-2  font-medium  max-w-7xl mx-auto">
      ...
      <nav className="flex flex-row  justify-start items-center w-full pb-3 gap-2 max-w-7xl mx-auto  ">
        <div className="relative md:w-1/4 md:min-w-[200px]">
          ...
          {isMenuOpen && (
            <div
              className="absolute mt-3 top-full left-0  w-screen  sm:w-[500%] md:w-[150%]  bg-gray-800 text-white rounded-r-3xl   sm:rounded-r-none sm:rounded-l-2xl  shadow-lg z-50 -ml-6 sm:-ml-0"
              ref={dropdownRef}
            >
        ...
        <div className="flex-grow w-auto sm:w-3/4  lg:w-2/3 max-w-[685px]">
